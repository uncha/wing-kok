...
export function fn_twitterTimelineCount(q, pageToken, callback) {
    ...
    var twitterPrm = {
        ...
        lang: "ko",
        locale: "ko",
        filter: "images", // "links, images, videos"
        include_entities: "true",
        tweet_mode: 'extended',
        max_id: pageToken,
        count: "50", //불러올 타임라인 수
        callback: "fn_makedocTwitterCount",//함수를 호출하여JSON데이터를 넘겨줍니다.
        //트위터개발자페이지에서 생성한 자신의 어플리케이션 정보를 입력하시기 바랍니다.

        consumerKey: "cXeGvyht14oSvANcgzw3Z8QRh",
        consumerSecret: "E3HjfS8Yo1TnF6YOMgAh0wyhxa66tAFFb5GBHjdnqqjWWBZnXo",
        accessToken: "3259407938-QKCdyCrgzLXd2jCSHNpZj7WUBpdbuFVTNxKSo8V",
        tokenSecret: "AHCoKmanQpPDamf0hL3H1Jlu64xH6JQR4iLAgxwRyiOk2"
    }
    ...
    var oauthMessage = {
        ...
        parameters: {
            q: twitterPrm.q,
            result_type: twitterPrm.result_type,
            //lang: twitterPrm.lang,
            //locale: twitterPrm.locale,
            filter: twitterPrm.filter,
            include_entities: twitterPrm.include_entities,
            max_id: twitterPrm.max_id,
    ...
    //console.log(twJsonPath);
    //$('#socialArea').html(twJsonPath);
    $.ajax({
...
window.fn_makedocTwitterCount = function(data) {
